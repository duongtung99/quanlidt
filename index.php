	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI DC</span></li> <br>
						
						<li>Địa chỉ: Hoàng Mai - Hà Nội </li>
						<li>Điện thoại: 0987654312 - Hotline:  0987654321</li>
				...
				<div id="copyright">
					<p>Sinh Viên : Hoàng Văn Chính,Phan Duy Dương | Lớp : Tin11a4 | Gmail : hoangckinh@gmail.com<p>
				</div><!-- End .copyright -->
